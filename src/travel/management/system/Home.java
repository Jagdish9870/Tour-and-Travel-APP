...
public class Home extends JFrame{
	...
	this.username = username;
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/dest7.jpeg"));
	...
	l1.setForeground(Color.BLACK);
        ...
        l1.setFont(new Font("Algerian", Font.BOLD, 70));
	l1.setBounds(195, 65, 1400, 100);
	NewLabel.add(l1);
        JLabel ll1 = new JLabel("One stop solution to manage all the records of customers ");
	ll1.setForeground(Color.WHITE);
        
        ll1.setFont(new Font("Algerian", Font.BOLD, 25));
	ll1.setBounds(600, 130, 1200, 50);
	NewLabel.add(ll1);
