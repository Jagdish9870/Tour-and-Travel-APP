    ...
    public Payment(){
        ...
        pay.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               ...
               jd= new JDialog(); 
               jd.setBounds(600, 270, 800, 600);  
                jd.setVisible(true);
               // jd.setLayout(null);
               jd.add(new Label("this is inside dialogueBox"));
        ImageIcon i111 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/paytm.jpg"));
        Image i81 = i111.getImage().getScaledInstance(800, 600, Image.SCALE_DEFAULT);
        ImageIcon i91 = new ImageIcon(i81);
        JLabel l41 = new JLabel(i91);
        l4.setBounds(0, 170, 300, 200);
        jd.add(l41);
